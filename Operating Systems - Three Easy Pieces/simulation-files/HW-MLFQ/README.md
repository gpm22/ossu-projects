...
This program, `mlfq.py`, allows you to see how the MLFQ scheduler behaves. As before, you can use this to generate problems for yourself using random seeds, or use it to construct a carefully-designed experiment to see how MLFQ works under different circumstances.
...
```bash
prompt> python3 mlfq.py --jlist 0,180,0:100,20,0 -q 10
```
