...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname person) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; person.rkt;
...
(check-expect (names-under-20 P1) (list "Robert"))
(check-expect (names-under-20 P3) (list "Robert" "Marie"))
(check-expect (names-under-20 P5) (list "N5"))
(check-expect (names-under-20 P6) (list "N5"))
(check-expect (names-under-20 P8) (list "N5" "N7"))
