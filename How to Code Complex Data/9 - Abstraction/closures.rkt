...
(check-expect (wide-only (list I1 I2 I3 I4 I5)) (list I2 I4 I5))
...
(check-expect (wider-than-only 40 LOI1) (list I3 I4 I5))

;(define (wider-than-only w loi) empty) ;stub

(define (wider-than-only w loi)
  (local [(define (wider-than? image) (>= (image-width image) w))]
...
(define (prefix-all p los)
  (local [(define (append str) (string-append p str))]
  (map append los)))
